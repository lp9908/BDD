<?php
	...
	if($valor == 10){
		...
		try{
			if($estado == 3 && $campo == ""){
				$consulta .= "SELECT * FROM empleado WHERE idEmpleado LIKE '%$campo%' OR nombre LIKE '%$campo%' OR tipoEmpleado LIKE '%$campo%' OR nombre LIKE '%$campo%' OR ap LIKE '%$campo%' OR am LIKE '%$campo%' OR email LIKE '%$campo%'";
			}else{
				if($estado == 0 && $campo == ""){
				...
				if(($estado == 0 || $estado == 1 || $estado == 3) && $campo != ""){
					...
					switch($tipoBusqueda){
						...
						case 6:
							...
							break;
						default:
							$consulta .= " AND	(idEmpleado LIKE '%$campo%' OR nombre LIKE '%$campo%' OR tipoEmpleado LIKE '%$campo%' OR nombre LIKE '%$campo%' OR ap LIKE '%$campo%' OR am LIKE '%$campo%' OR email LIKE '%$campo%')";
							break;
					}
				}
			}
